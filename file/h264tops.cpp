...
int test264tompegps(char* h264path, char* pspath)
{
	...
	while( 1 )
	{
		...
		int outlen = lts_ps_stream(&es, g_outbuf, BUF_SIZE, &g_prog_info);
		if (outlen > 0)
		{
