...
/* ./.libs/lt-sip_reg.c - temporary wrapper executable for .libs/sip_reg
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.11

   The sip_reg program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/projects/osip/libexosip2-5.0.0/src/.libs:/usr/local/lib:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/local/lib:/usr/local/bin:/projects/osip/libexosip2-5.0.0/src/.libs:";
const char * TARGET_PROGRAM_NAME = "sip_reg"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sip_reg - temporary wrapper script for .libs/sip_reg\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.11\n", f);
  fputs ("#\n", f);
  fputs ("# The sip_reg program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libeXosip2.la /usr/local/lib/libosip2.la /usr/local/", f);
  fputs ("lib/libosipparser2.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"sip_reg:sip_reg:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian", f);
  fputs ("-2.4.2-1.11\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sip_reg:sip_reg:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sip_reg:sip_reg:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/usr/local/lib:/usr/local/bin:/projects/osip/libexosip2-5.0.0/src/.lib", f);
  fputs ("s:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/projects/osip/libexosip2-5.0.0/src/.libs:/usr/local/lib:$PATH\"\n", f);
  fputs ("\n", f);
